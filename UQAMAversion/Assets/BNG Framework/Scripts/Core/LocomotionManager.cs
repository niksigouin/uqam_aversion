    ...
    public class LocomotionManager : MonoBehaviour {
        ...
        void OnEnable() {
            if(LocomotionToggleAction) {
                ...
                LocomotionToggleAction.action.canceled += OnLocomotionToggle;
            }
        }
        ...
        public void OnLocomotionToggle(InputAction.CallbackContext context) {
            ...
            {
                SetLocomationState(true);
            } else if (context.canceled)
            {
                SetLocomationState(false);
            }
        ...
        private void SetLocomationState(bool state)
        {
            toggleSmoothLocomotion(state);
        }
