...
namespace BNG {
    ...
    public class PlayerTeleport : MonoBehaviour {
        ...
        public void DoCheckTeleport() {
            ...
            if (TeleportLine != null) TeleportLine.enabled = true;
            ...
            updatedColor.a = 1;
            if (TeleportLine != null) TeleportLine.startColor = updatedColor;

            updatedColor.a = 0;
            if (TeleportLine != null) TeleportLine.endColor = updatedColor;

            // Explicitly set width to force redraw of linerender
            if (TeleportLine != null) TeleportLine.startWidth = _initialLineWidth;
        ...
        public void TeleportPlayerToTransform(Transform destination) {
            // TODO: PLAYER TELEPORT !!! CHANGE TO TRUE IF NECESSARY
            StartCoroutine(doTeleport(destination.position, destination.rotation, false));
        }
